...
def extract_sections(pdf_path, output_dir, text_counter, toc_sections,
                     all_texts):
...
def extract(input_dir, output_dir):
    ...
    for pdf in pdf_files:
        ...
        text_counter = extract_sections(pdf_path, output_dir, text_counter,
                                        toc_sections, all_texts)
